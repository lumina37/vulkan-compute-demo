...
int main() {
    ...
    vkc::StorageImageBox srcImageBox =
        vkc::StorageImageBox::create(pDeviceBox, srcImage.getExtent(), vkc::StorageType::ReadOnly) | unwrap;
    ...
    for (int i = 0; i < 15; i++) {
        ...
        grayCmdBufBox.recordPrepareReceive<vkc::StorageImageBox>(srcImageBoxRefs);
        ...
        grayCmdBufBox.recordPrepareShaderRead<vkc::StorageImageBox>(srcImageBoxRefs);
