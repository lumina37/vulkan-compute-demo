...
TimestampQueryPoolBox::TimestampQueryPoolBox(std::shared_ptr<DeviceBox>&& pDeviceBox, vk::QueryPool queryPool,
                                             int queryCount, float timestampPeriod) noexcept
...
std::expected<TimestampQueryPoolBox, Error> TimestampQueryPoolBox::create(std::shared_ptr<DeviceBox> pDeviceBox,
                                                                          int queryCount,
